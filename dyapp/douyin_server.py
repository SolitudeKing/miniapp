...
class Miniapp(Douyin):
    ...
    @classmethod
    def loginVerify(cls, appid: str, secret: str, code: str, anonymous_code: str = None) -> dict:
        """
        登录
        ...
        verify_response = requests.get(verify_url, headers=cls.headers, params=verify_params)
